...
! function (t, e) {
    ...
    function e() {
        return "complete" === document.readyState || "loading" !== document.readyState && !Ot.doScroll
    }
    ...
    function l(t, e, i, n) {
        return void 0 === i && (i = 400), void 0 === n && (n = "linear"), C(function (s, r) {
            t = St(t);
            for (var a in e) t.css(a, t.css(a));
            var l = setTimeout(function () {
                return t.trigger(ae)
            }, i);
            o(t, ae + " " + Pt, function (e) {
                var i = e.type;
                clearTimeout(l), t.removeClass("uk-transition").css("transition", ""), i === Pt ? r() : s()
            }, !1, function (e) {
                var i = e.target;
                return t.is(i)
    ...
    function h(t, e, i, n, s) {
        var r = arguments;
        return void 0 === i && (i = 200), C(function (a, l) {
            function c() {
                t.css("animation-duration", ""), f(t, jt + "\\S*")
            }
            if ((t = St(t)).hasClass(Ft)) Gt(function () {
                return C.resolve().then(function () {
                    return h.apply(null, r).then(a, l)
                })
            });
            else {
                var u = e + " " + jt + (s ? "leave" : "enter");
                0 === e.lastIndexOf(jt, 0) && (n && (u += " " + jt + n), s && (u += " " + jt + "reverse")), c(), o(t, (he || "animationend") + " " + Ht, function (e) {
                    var i = !1;
                    e.type === Ht ? l() : a(), Gt(function () {
                        i || (t.addClass(Ft), Gt(function () {
                    ...
                    var i = e.target;
                    return t.is(i)
                }), t.css("animation-duration", i + "ms").addClass(u), he || Gt(function () {
                    return Lt.cancel(t)
                })
            }
        })
    ...
    function u(t, e) {
        return !!(t = St(t)).is(e) || (N(e) ? t.parents(e).length : F(e).contains(t[0]))
    }
    ...
    function p(t, e, i, n) {
        if (void 0 === e && (e = !0), void 0 === i && (i = !1), void 0 === n && (n = !1), N(t)) {
    ...
    function w(t, e, i) {
        void 0 === i && (i = 0), e = St(e);
        var n = St(e).length;
        return (t = (B(t) ? t : "next" === t ? i + 1 : "previous" === t ? i - 1 : N(t) ? parseInt(t, 10) : e.index(t)) % n) < 0 ? t + n : t
    }

    function b(t) {
        return Wt[F(t).tagName.toLowerCase()]
    }
    ...
    function H(t) {
        return M(t) && t.split(/(?=\s[!>+-])/g).map(function (t) {
            return t.trim()
        })
    }
    ...
    function j(t, e) {
        ...
        try {
            if (e && M(t) && ">" !== t[0]) {
                var i = Ut[t[0]],
                    n = t.substr(1);
                e = St(e), "closest" === i && (e = e.parent(), n = n || "*"), t = e[i](n)
            } else t = St(t, e)
        } catch (t) {
            return null
        }
    ...
    function W(e) {
        return Vt(e) ? e : N(e) ? e.split(",").map(function (e) {
    ...
    function q(t) {
        if (N(t))
            if ("@" === t[0]) {
                ...
                t = Xt[e] || (Xt[e] = parseFloat(J(e)))
            } else if (isNaN(t)) return t;
        return !(!t || isNaN(t)) && "(min-width: " + t + "px)"
    }

    function R(t, e, i) {
        return t === Boolean ? z(e) : t === Number ? L(e) : "jQuery" === t ? y(e, i) : "list" === t ? W(e) : "media" === t ? q(e) : t ? t(e) : e
    }
    ...
    function G(t, e) {
        var i, n = T(t),
            ...
            a = (i = {}, i[t] = s, i["Webkit" + n] = "webkit" + o, i["Moz" + n] = s, i["o" + n] = "o" + o + " o" + s, i);
        for (t in a)
            if (void 0 !== r.style[t]) return a[t]
    }

    function Z() {
        ce.scheduled || (ce.scheduled = !0, Gt(ce.flush.bind(ce)))
    }
    ...
    function st(t, e) {
        try {
            t.contentWindow.postMessage(JSON.stringify(Qt({
                event: "command"
            }, e)), "*")
        } catch (t) {}
    }
    ...
    function rt(e, i, n, s, o, r, a, l) {
        ...
        var c = at(e),
            u = at(i),
            d = u;
        return ut(d, n, c, -1), ut(d, s, u, 1), o = ft(o, c.width, c.height), r = ft(r, u.width, u.height), o.x += r.x, o.y += r.y, d.left += o.x, d.top += o.y, l = at(l || window), a && t.each(be, function (t, e) {
            function i(e, i) {
                var n = d[f] + e + i - 2 * o[t];
                if (n >= l[f] && n + c[r] <= l[p]) return d[f] = n, ["element", "target"].forEach(function (i) {
                    h[i][t] = e ? h[i][t] === be[t][1] ? be[t][2] : be[t][1] : h[i][t]
                }), !0
            }
            var r = e[0],
                f = e[1],
    ...
    function ut(e, i, n, s) {
        t.each(be, function (t, o) {
            var r = o[0],
                a = o[1],
                l = o[2];
            i[t] === l ? e[a] += n[r] * s : "center" === i[t] && (e[a] += n[r] * s / 2)
        })
    }
    ...
    function mt() {
        ge && clearTimeout(ge), me && clearTimeout(me), ve && clearTimeout(ve), ge = me = ve = null, $e = {}
    }

    function vt(t) {
        return xe || "touch" === (t.originalEvent || t).pointerType
    }

    function wt(t) {
        It.on((e = {}, e["click." + t] = function (t) {
            Ae && Ae.bgClose && !t.isDefaultPrevented() && !u(t.target, Ae.panel) && Ae.hide()
        }, e["keydown." + t] = function (t) {
            27 === t.keyCode && Ae && Ae.escClose && (t.preventDefault(), Ae.hide())
        }, e));
        var e
    }
    ...
    function yt(t) {
        ...
        yt.installed || t.component("countdown", {
                ...
                write: function () {
                    ...
                    i.total <= 0 && (this.stop(), i.days = i.hours = i.minutes = i.seconds = 0), this.units.forEach(function (e) {
                        ...
                        if (n = n.length < 2 ? "0" + n : n, t[e].text() !== n) {
                            var s = t[e];
                            (n = n.split("")).length !== s.children().length && s.empty().append(n.map(function () {
                                return "<span></span>"
    ...
    function $t(t) {
        function e(t, e, i, n, o, r) {
            ...
            return {
                ...
                show: function (t, s) {
                    var o = this;
                    return void 0 === s && (s = 0), t -= Math.round(t * s), this.translate(s), g.all([v.start(i, a[0], t, e), v.start(n, a[1], t, e)]).then(function () {
                        o.reset(), r()
                    }, l)
                },
                stop: function () {
                ...
                methods: {
                    ...
                    move: function (n) {
                        ...
                        if (!(this.pos === this.prevPos || !this.touching && Math.abs(r - this.pos) < this.threshold)) {
                            ...
                            if (this.percent !== c) {
                                ...
                                }), u && this._animation && this._animation.reset(), this._animation = new e(this.animation, this.transition, f, m, p, l), this._animation.translate(Math.abs(c % 1)), this.percent = c, t.update(null, f), t.update(null, m)
                            }
                        }
                    },
                    end: function (t) {
                        if (t.preventDefault(), c(o, d, this.move, !0), c(o, f, this.end, !0), this.touching) {
                            var e = this.percent;
                    ...
                    show: function (i, n) {
                        ...
                        if (void 0 === n && (n = !1), n || !this.touch)
                            if (this.stack[n ? "unshift" : "push"](i), !n && this.stack.length > 1) 2 === this.stack.length && this._animation.forward(this.forwardDuration);
                            else {
                                var o = this.slides.hasClass("uk-active"),
                                    a = "next" === i ? 1 : "previous" === i ? -1 : i < this.index ? -1 : 1;
                                if (i = this.getIndex(i), o && i === this.index) this.stack[n ? "shift" : "pop"]();
                                else {
                                    var l = o && this.slides.eq(this.index),
                                        h = this.slides.eq(i);
                                    this.$el.trigger("beforeitemshow", [this, h]), l && this.$el.trigger("beforeitemhide", [this, l]), this.index = i, this.$addClass(h, this.clsActive), this._animation = new e(l ? this.animation : "scale", this.transition, l || h, h, a, function () {
                                        l && s.$removeClass(l, s.clsActive), s.stack.shift(), s.stack.length ? m(function () {
                                            return s.show(s.stack.shift(), !0)
                                        }) : s._animation = null, s.$el.trigger("itemshown", [s, h]), t.update(null, h), l && (s.$el.trigger("itemhidden", [s, l]), t.update(null, l))
                                    }), this._animation.show(this.stack.length > 1 ? this.forwardDuration : this.duration, this.percent), this.$el.trigger("itemshow", [this, h]), l && (this.$el.trigger("itemhide", [this, l]), t.update(null, l)), t.update(null, h), r.flush()
                                }
                            }
                    },
                    getIndex: function (t) {
            ...
            t.component("lightbox", {
                ...
                computed: {
                    toggles: function () {
                        ...
                        return this._changed = !this._toggles || e.length !== this._toggles.length || e.toArray().some(function (e, i) {
                ...
                computed: {
                    container: function () {
                        return o(!0 === this.$props.container && t.container || this.$props.container || t.container)
                    }
                },
                created: function () {
                    var t = this;
                ...
                events: [{
                    ...
                    handler: function (t, e) {
                        ...
                        if (this.setItem(e, "<span uk-spinner></span>"), r) {
                            if ("image" === a || r.match(/\.(jp(e)?g|png|gif|svg)$/i)) f(r).then(function (t) {
                                return s.setItem(e, '<img width="' + t.width + '" height="' + t.height + '" src="' + r + '">')
                            }, function () {
                                return s.setError(e)
                            });
                            else if ("video" === a || r.match(/\.(mp4|webm|ogv)$/i)) var h = o("<video controls playsinline uk-video></video>").on("loadedmetadata", function () {
                                return s.setItem(e, h.attr({
                            ...
                            else if ("iframe" === a) this.setItem(e, '<iframe class="uk-lightbox-iframe" src="' + r + '" frameborder="0" allowfullscreen></iframe>');
                                ...
                                f("//img.youtube.com/vi/" + c + "/maxresdefault.jpg").then(function (t) {
                                    120 === t.width && 90 === t.height ? f("//img.youtube.com/vi/" + c + "/0.jpg").then(function (t) {
                                        return u(t.width, t.height)
                                    }, u) : u(t.width, t.height)
                                }, u)
                            } else {
            ...
            t.component("sortable", {
                ...
                methods: {
                    init: function (t) {
                        ...
                        }, this.pos), r.on(p, this.move), r.on(g, this.end), w.on("scroll", this.scroll), this.threshold || this.start(t))
                    },
                    start: function (e) {
                    ...
                    move: function (t) {
                        if (this.drag) {
                            ...
                            var i = "mousemove" === t.type ? t.target : document.elementFromPoint(this.pos.x - document.body.scrollLeft, this.pos.y - document.body.scrollTop),
                                ...
                                r = n !== o;
                            if (n && !c(i, this.placeholder) && (!r || n.group && n.group === o.group)) {
                                if (i = n.$el.is(i.parentNode) && s(i) || n.$el.children().has(i), r) o.remove(this.placeholder);
                    ...
                    scroll: function () {
                        ...
                        if (r.off(p, this.move), r.off(g, this.end), w.off("scroll", this.scroll), this.drag) {
                            m();
                        ...
                        } else "mouseup" !== t.type && c(t.target, "a[href]") && (location.href = s(t.target).closest("a[href]").attr("href"))
                    },
                    insert: function (t, e) {
                        var i = this;
    ...
    function Tt(t) {
        if (!Tt.installed) {
            ...
            t.component("tooltip", {
                ...
                computed: {
                    container: function () {
                        return n(!0 === this.$props.container && t.container || this.$props.container || t.container)
                    }
                },
                connected: function () {
                    var t = this;
                ...
                methods: {
                    show: function () {
                        var t = this;
                        ~d.indexOf(this) || (d.forEach(function (t) {
                            return t.hide()
                        }), d.push(this), s.on("click." + this.$options.name, function (e) {
                    ...
                    hide: function () {
                        ...
                        !~t || this.$el.is("input") && this.$el[0] === document.activeElement || (d.splice(t, 1), clearTimeout(this.showTimer), clearInterval(this.hideTimer), this.$el.attr("aria-expanded", !1), this.toggleElement(this.tooltip, !1), this.tooltip && this.tooltip.remove(), this.tooltip = !1, s.off("click." + this.$options.name))
                    }
                },
                events: (f = {
                    blur: "hide"
                    ...
                    upload: function (t) {
                        ...
                        if (t.length) {
                            ...
                            for (var a = 0; a < t.length; a++) {
                                if (n.allow && !e(n.allow, t[a].name)) return void n.fail(n.msgInvalidName.replace(/%s/, n.allow));
                                if (n.mime && !e(n.mime, t[a].type)) return void n.fail(n.msgInvalidMime.replace(/%s/, n.mime))
                            }
                                ...
                                h = function (t) {
                                    ...
                                    o({
                                        ...
                                        complete: [n.complete, function (t, e) {
                                            l.length ? h(l.shift()) : n.completeAll && n.completeAll(t), "abort" === e && n.abort && n.abort(t)
                                        }],
                                        cache: !1,
                                        contentType: !1,
                                        processData: !1,
    ...
    function Et(t) {
        ...
        function i(t, e) {
            return +(h(t.diff) ? +t.end : t.start + t.diff * e * (t.start < t.end ? 1 : -1)).toFixed(2)
        }
        if (!Et.installed) {
            var n = t.mixin,
                s = t.util,
            ...
            n.parallax = {
                props: d.reduce(function (t, e) {
                    return t[e] = "list", t
                }, {
                    easing: Number,
                    media: "media"
                }),
                defaults: d.reduce(function (t, e) {
                    return t[e] = void 0, t
                }, {
                    easing: 1,
                    media: !1
                    ...
                    props: function () {
                        ...
                        return d.reduce(function (i, n) {
                            ...
                            var s = n.match(/color/i),
                                ...
                                a = t.$props[n];
                            r && t.$el.css(n, "");
                            var l, c = (h(a[1]) ? "scale" === n ? 1 : r ? t.$el.css(n) : 0 : a[0]) || 0,
                                u = h(a[1]) ? a[0] : a[1],
                                d = ~a.join("").indexOf("%") ? "%" : "px";
                            if (s) {
                                var f = t.$el[0].style.color;
                                t.$el[0].style.color = c, c = e(t.$el.css("color")), t.$el[0].style.color = u, u = e(t.$el.css("color")), t.$el[0].style.color = f
                            ...
                            if (this._active) {
                                ...
                                this.bgProps.forEach(function (s) {
                                    var o = t.props[s],
                                        ...
                                        f = n[d] - i[d];
                                    if (c.match(/%$/)) {
                                        if (l >= h) f < u ? (i[d] = n[d] + u - f, t.props[s].pos = "0px") : (c = -1 * f / 100 * parseFloat(c), c = r(c, u - f, 0), t.props[s].pos = c + "px");
                                        else {
                                            if (f < u) i[d] = n[d] + u - f;
                            ...
                            switch (o) {
                                ...
                                case "y":
                                    ...
                                    var l = ["x", "y"].map(function (e) {
                                            return o === e ? a + r.unit : n[e] ? i(n[e], t) + n[e].unit : 0
                                        }),
                                        h = l[0],
                                        c = l[1];
                                ...
                                case "bgy":
                                case "bgx":
                                    s["background-position-" + o[2]] = "calc(" + r.pos + " + " + (a + r.unit) + ")";
                                    break;
                                case "color":
                ...
                computed: {
                    target: function () {
                        return this.$props.target && u(this.$props.target, this.$el) || this.$el
                    }
                },
                disconnected: function () {
                    delete this._prev
                ...
                update: [{
                    ...
                    write: function () {
                        this._active ? this._prev !== this._percent && (this.$el.css(this.getCss(this._percent)), this._prev = this._percent) : this.reset()
                    },
                    events: ["scroll", "load", "resize"]
                }]
            })
    ...
    var St = "default" in t ? t.default : t,
        ...
        Mt = {
            start: l,
            stop: function (t) {
                return r(t, ae), C.resolve()
            },
            cancel: function (t) {
                return r(t, Pt), C.resolve()
            },
        ...
        Ht = "animationcancel",
        jt = "uk-animation-",
        Ft = "uk-cancel-animation",
        zt = new RegExp(jt + "(enter|leave)"),
        Lt = { in: function (t, e, i, n) {
                return h(t, e, i, n, !1)
            },
            ...
            inProgress: function (t) {
                return zt.test(St(t).attr("class"))
            },
            cancel: function (t) {
                return r(t, Ht), C.resolve()
            }
        },
        Wt = {
            area: !0,
        ...
        qt = {
            ...
            contain: function (e, i) {
                var n = this;
                return e = Qt({}, e), t.each(e, function (t) {
    ...
    C.resolve = function (t) {
        ...
        return te ? Promise.all(t) : St.when.apply(St, t)
    };
    var Yt = /-(\w)/g,
        Vt = Array.isArray,
        Ut = {
        ...
        Qt = Object.assign || function (t) {
            ...
            for (var n = 0; n < e.length; n++) {
                var s = e[n];
                if (null !== s)
                    for (var o in s) k(s, o) && (t[o] = s[o])
            }
            return t
        },
        Jt = window.MutationObserver || window.WebKitMutationObserver,
        Gt = window.requestAnimationFrame || function (t) {
            return setTimeout(t, 1e3 / 60)
        },
        Zt = "ontouchstart" in window,
        Kt = window.PointerEvent,
        te = "Promise" in window,
        ee = "ontouchstart" in window || window.DocumentTouch && document instanceof DocumentTouch || navigator.msPointerEnabled && navigator.msMaxTouchPoints || navigator.pointerEnabled && navigator.maxTouchPoints,
        ie = ee ? "mousedown " + (Zt ? "touchstart" : "pointerdown") : "mousedown",
        ne = ee ? "mousemove " + (Zt ? "touchmove" : "pointermove") : "mousemove",
        se = ee ? "mouseup " + (Zt ? "touchend" : "pointerup") : "mouseup",
        oe = ee && Kt ? "pointerenter" : "mouseenter",
        re = ee && Kt ? "pointerleave" : "mouseleave",
        ae = G("transition", "transition-end"),
        le = G("animation", "animation-start"),
        he = G("animation", "animation-end"),
        ce = {
            reads: [],
            writes: [],
            measure: function (t) {
            ...
            flush: function () {
                K(this.reads), K(this.writes.splice(0, this.writes.length)), this.scheduled = !1, (this.reads.length || this.writes.length) && Z()
            }
        };
    et.prototype = {
        positions: [],
    ...
    var ue = {};
    ue.args = ue.created = ue.events = ue.init = ue.ready = ue.connected = ue.disconnected = ue.destroy = function (t, e) {
        return t = t && !Vt(t) ? [t] : t, e ? t ? t.concat(e) : Vt(e) ? e : [e] : t
    }, ue.update = function (t, e) {
        return ue.args(t, S(e) ? {
            read: e
        } : e)
    }, ue.props = function (t, e) {
        return Vt(e) && (e = e.reduce(function (t, e) {
            return t[e] = String, t
        }, {})), ue.methods(t, e)
    }, ue.computed = ue.defaults = ue.methods = function (t, e) {
        return e ? t ? Qt({}, t, e) : e : t
    };
    var de = function (t, e) {
            return P(e) ? t : e
        },
        fe = 0,
        pe = function (t) {
            this.id = ++fe, this.el = F(t)
        };
    pe.prototype.isVideo = function () {
        return this.isYoutube() || this.isVimeo() || this.isHTML5()
    }, pe.prototype.isHTML5 = function () {
        return "VIDEO" === this.el.tagName
    }, pe.prototype.isIFrame = function () {
        return "IFRAME" === this.el.tagName
    }, pe.prototype.isYoutube = function () {
        return this.isIFrame() && !!this.el.src.match(/\/\/.*?youtube\.[a-z]+\/(watch\?v=[^&\s]+|embed)|youtu\.be\/.*/)
    }, pe.prototype.isVimeo = function () {
        return this.isIFrame() && !!this.el.src.match(/vimeo\.com\/video\/.*/)
    }, pe.prototype.enableApi = function () {
        var t = this;
        if (this.ready) return this.ready;
        var e, i = this.isYoutube(),
            n = this.isVimeo();
        return i || n ? this.ready = C(function (s) {
            o(t.el, "load", function () {
                ...
                s(), e && clearInterval(e)
            }), t.el.setAttribute("src", t.el.src + (~t.el.src.indexOf("?") ? "&" : "?") + (i ? "enablejsapi=1" : "api=1&player_id=" + fe))
        }) : C.resolve()
    ...
    i(function () {
        n(document, "click", function () {
            return we = !0
        }, !0), n(document, ie, function (t) {
            var e = t.touches ? t.touches[0] : t,
                i = e.target,
                n = e.pageX,
                s = e.pageY,
                o = Date.now();
            $e.el = "tagName" in i ? i : i.parentNode, ge && clearTimeout(ge), $e.x1 = n, $e.y1 = s, $e.last && o - $e.last <= 250 && ($e = {}), $e.last = o, we = t.button > 0
        }), n(document, ne, function (t) {
            var e = t.touches ? t.touches[0] : t,
                i = e.pageX,
                n = e.pageY;
            $e.x2 = i, $e.y2 = n
            ...
            var e = t.target;
            $e.x2 && Math.abs($e.x1 - $e.x2) > 30 || $e.y2 && Math.abs($e.y1 - $e.y2) > 30 ? me = setTimeout(function () {
                $e.el && (r($e.el, "swipe"), r($e.el, "swipe" + gt($e))), $e = {}
            }) : "last" in $e ? (ve = setTimeout(function () {
                return $e.el && r($e.el, "tap")
            }), $e.el && u(e, $e.el) && (ge = setTimeout(function () {
                ge = null, $e.el && !we && r($e.el, "click"), $e = {}
            }, 350))) : $e = {}
        }), n(document, "touchcancel", mt), n(window, "scroll", mt)
    });
    var xe = !1;
    ...
    var ke, Ce, Te = Object.freeze({
        ...
        scrolledOver: function (t) {
            ...
            return U((s + window.pageYOffset - i) / ((s + (e - (o < n ? o : 0))) / 100) / 100)
        },
        docHeight: v,
        getIndex: w,
        isVoidElement: b,
    ...
    ! function () {
        ...
        t && (t.add("a", "b"), t.toggle("c", !1), ke = t.contains("b"), Ce = !t.contains("c")), t = null
    }();
    var _e = function (t) {
        this._init(t)
    };
    _e.util = Te, _e.data = "__uikit__", _e.prefix = "uk-", _e.options = {}, _e.instances = {}, _e.elements = [],
        function (t) {
            function e(t) {
            ...
            t.use = function (t) {
                ...
                i = (N(i) ? t.components[i] : i) || this, (e = nt({}, e)).mixins = i.options.mixins, delete i.options.mixins, i.options = nt(e, i.options)
            }, t.extend = function (t) {
                var i = this,
                    n = e((t = t || {}).name || i.options.name || "UIkitComponent");
                return n.prototype = Object.create(i.prototype), n.prototype.constructor = n, n.options = nt(i.options, t), n.super = i, n.extend = i.extend, n
        ...
        function (t) {
            t.prototype._callHook = function (t) {
                ...
                i && i.forEach(function (i, n) {
                    ("update" === t.type || i.events && ~i.events.indexOf(t.type)) && (i.read && !~ce.reads.indexOf(e._frames.reads[n]) && (e._frames.reads[n] = ce.measure(function () {
                        i.read.call(e, t), delete e._frames.reads[n]
                    })), i.write && !~ce.writes.indexOf(e._frames.writes[n]) && (e._frames.writes[n] = ce.mutate(function () {
        ...
        function (t) {
            ...
            function n(t, e, i) {
                Object.defineProperty(t, e, {
                    enumerable: !0,
                    get: function () {
                        return k(t._computeds, e) || (t._computeds[e] = i.call(t)), t._computeds[e]
                    },
                    set: function (i) {
                        t._computeds[e] = i
                    }
            ...
            function s(t, e, i, n) {
                ...
                if (r = r && r.call(t) || t.$el, s = s.split(" ").map(function (t) {
                    ...
                    c = N(c) ? t[c] : x(c, t), l && (c = o(c, t)), a ? r.on(s, N(a) ? a : a.call(t), c) : r.on(s, c)
                }
            }
            ...
            function a(t, e) {
                return P(t) || t === e || c(t) && c(e) && t.is(e)
            }
            var l = 0;
            t.prototype.props = {}, t.prototype._init = function (e) {
                e = e || {}, e = this.$options = nt(this.constructor.options, e, this), this.$el = null, this.$name = t.prefix + _(this.$options.name), this.$props = {}, this._frames = {
                    reads: {},
                    writes: {}
                ...
                void 0 === o && (o = {});
                var r = e.el;
                s.length && Vt(n) && (n = n.slice(0, s.length).reduce(function (t, e, i) {
                    return D(e) ? Qt(t, e) : t[s[i]] = e, t
                }, {}));
                for (var a in i) t.$props[a] = t[a] = k(n, a) && !P(n[a]) ? R(o[a], n[a], r) : Vt(i[a]) ? i[a].concat() : i[a]
            }, t.prototype._initMethods = function () {
                var t = this,
                    e = this.$options.methods;
                if (e)
                    for (var i in e) t[i] = x(e[i], t)
                ...
                var i = this;
                this._computeds = {}, Qt(this.$props, t || e(this.$options, this.$name));
                ...
                var t = this,
                    ...
                    s = i.props,
                    o = i.el;
                !this._observer && s && n && Jt && (n = Vt(n) ? n : Object.keys(s).map(function (t) {
                    return _(t)
                }), this._observer = new Jt(function () {
        ...
        function (t) {
            ...
            t.prototype.$mount = function (t) {
                ...
                t[e] || (t[e] = {}), t[e][i] || (t[e][i] = this, this.$options.el = this.$options.el || t, this.$el = St(t), this._initProps(), this._callHook("init"), document.documentElement.contains(t) && this._callConnected())
            ...
            t.components = {}, t.component = function (e, i) {
                ...
                return t.components[n] = i, t[n] = function (e, i) {
                    ...
                    return D(e) ? new t.components[n]({
                        ...
                        data: [].concat(r)
                    }) : e && e.nodeType ? s(e) : St(e).toArray().map(s)[0]
                }, t._initialized && !i.options.functional && ce.measure(function () {
                ...
                for (var s = 0; s < i.attributes.length; s++) 0 !== (n = i.attributes[s].name).lastIndexOf("uk-", 0) && 0 !== n.lastIndexOf("data-uk-", 0) || (n = A(n.replace("data-uk-", "").replace("uk-", "")), t[n] && t[n](i))
        ...
        function (t) {
            function e(t, e, n) {
                (e = i(e, t)) && (ke ? e[0][n].apply(e[0], e.slice(1)) : e.slice(1).forEach(function (t) {
                    return e[0][n](t)
                }))
            }

            function i(t, e) {
                return N(t[0]) && t.unshift(e), t[0] = (F(t[0]) || {}).classList, t.forEach(function (e, i) {
                    return i > 0 && N(e) && ~e.indexOf(" ") && Array.prototype.splice.apply(t, [i, 1].concat(t[i].split(" ")))
            ...
            t.prototype.$addClass = function () {
                ...
                for (var t = [], e = arguments.length; e--;) t[e] = arguments[e];
                for (var n = (t = i(t, this.$options.el)) && !N(t[t.length - 1]) ? t.pop() : void 0, s = 1; s < (t && t.length); s++) t[0] && Ce ? t[0].toggle(t[s], n) : t[0][(P(n) ? !t[0].contains(t[s]) : n) ? "add" : "remove"](t[s])
            }
        }(_e);
    var Ae, Ee, Se = {
            init: function () {
        ...
        Oe = {
            ...
            methods: {
                toggleElement: function (t, e, i) {
                    ...
                    return C(function (s) {
                        var o, r = function (t) {
                            ...
                            a = (t = St(t).toArray()).filter(function (t) {
                        ...
                        if (n.queued && P(i) && P(e) && n.hasAnimation && !(t.length < 2)) {
                            var h = document.body,
                                c = h.scrollTop,
                                u = a[0],
                                d = Lt.inProgress(u) && n.$hasClass(u, "uk-animation-leave") || Mt.inProgress(u) && "0px" === u.style.height;
                            o = r(a), d || (o = o.then(function () {
                                var t = r(l);
                ...
                toggleNow: function (t, e) {
                    var i = this;
                    return C(function (n) {
                        return C.all(St(t).toArray().map(function (t) {
                            return i._toggleElement(t, e, !1)
                        })).then(n, X)
                    })
                },
                isToggled: function (t) {
                    return t = t && St(t) || this.$el, this.cls ? t.hasClass(this.cls.split(" ")[0]) : !t.attr("hidden")
                },
                ...
                _toggleElement: function (e, i, n) {
                    var s = this;
                    if (e = St(e), i = I(i) ? i : Lt.inProgress(e) ? this.$hasClass(e, "uk-animation-leave") : Mt.inProgress(e) ? "0px" === e[0].style.height : !this.isToggled(e), !1 === a(e, "before" + (i ? "show" : "hide"), [this]).result) return C.reject();
                    var o = (!1 !== n && this.hasAnimation ? this.hasTransition ? this._toggleHeight : this._toggleAnimation : this._toggleImmediate)(e, i),
                        r = t.Event(i ? "show" : "hide");
                    return r.preventDefault(), a(e, r, [this]), o.then(function () {
                        a(e, i ? "shown" : "hidden", [s]), _e.update(null, e)
                    })
                },
                _toggle: function (t, e) {
                    t = St(t), this.cls ? t.toggleClass(this.cls, ~this.cls.indexOf(" ") ? void 0 : e) : t.attr("hidden", !e), t.find("[autofocus]:visible").focus(), this.updateAria(t), _e.update(null, t)
                },
                ...
                _toggleHeight: function (t, e) {
                    var i, n = this,
                        ...
                        a = t[0].offsetHeight ? t.height() + (o ? 0 : r) : 0;
                    return Mt.cancel(t), this.isToggled(t) || this._toggle(t, !0), t.height(""), ce.flush(), i = t.height() + (o ? 0 : r), t.height(a), (e ? Mt.start(t, Qt({}, this.initProps, {
                        overflow: "hidden",
                        height: i
                    }), Math.round(this.duration * (1 - a / i)), this.transition) : Mt.start(t, this.hideProps, Math.round(this.duration * (a / i)), this.transition).then(function () {
                ...
                _toggleAnimation: function (t, e) {
                    var i = this;
                    return Lt.inProgress(t) ? Lt.cancel(t).then(function () {
                        return Lt.inProgress(t) ? C.resolve().then(function () {
                            return i._toggleAnimation(t, e)
                        }) : i._toggleAnimation(t, e)
                    }) : e ? (this._toggle(t, !0), Lt.in(t, this.animation[0], this.duration, this.origin)) : Lt.out(t, this.animation[1] || this.animation[0], this.duration, this.origin).then(function () {
        ...
        De = {
            ...
            computed: {
                ...
                container: function () {
                    return F(!0 === this.$props.container && _e.container || this.$props.container && j(this.$props.container))
                },
            ...
            events: [{
                ...
                self: !0,
                handler: function () {
                    Nt.hasClass(this.clsPage) || (this.scrollbarWidth = window.innerWidth - Nt[0].offsetWidth, this.body.css("overflow-y", this.scrollbarWidth && this.overlay ? "scroll" : "")), Nt.addClass(this.clsPage)
                }
            }, {
                name: "hidden",
                self: !0,
                handler: function () {
                    this.component.active === this && (Nt.removeClass(this.clsPage), this.body.css("overflow-y", ""), this.component.active = null)
                }
            }],
            methods: {
                toggle: function () {
                ...
                show: function () {
                    var t = this;
                    if (!this.isToggled()) {
                        if (this.container && !this.$el.parent().is(this.container)) return this.container.appendChild(this.$el[0]), C(function (e) {
                            return Gt(function () {
                                return e(t.show())
                            })
                        });
                        var e = Ae && Ae !== this && Ae;
                        if (Ae = this, this.component.active = this, e) {
                ...
                hide: function () {
                    if (this.isToggled()) return (Ae = Ae && Ae !== this && Ae || this.prev) || bt(this.$options.name), this.toggleNow(this.$el, !1)
                },
                getActive: function () {
                    return Ae
                },
                _toggleImmediate: function (t, e) {
                    ...
                    }), this.transitionDuration ? C(function (t, e) {
                        i._transition && (i.transitionElement.off(ae, i._transition.handler), i._transition.reject()), i._transition = {
                            reject: e,
                            handler: function () {
                                t(), i._transition = null
                            }
                        }, i.transitionElement.one(ae, i._transition.handler)
                    }) : C.resolve()
                }
            }
        },
            ...
            methods: {
                positionAt: function (t, e, i) {
                    ...
                    var n = L(this.offset) || 0,
                        s = this.getAxis(),
                        o = rt(t, e, "x" === s ? pt(this.dir) + " " + this.align : this.align + " " + pt(this.dir), "x" === s ? this.dir + " " + this.align : this.align + " " + this.dir, "x" === s ? "" + ("left" === this.dir ? -1 * n : n) : " " + ("top" === this.dir ? -1 * n : n), null, this.flip, i);
                    this.dir = "x" === s ? o.target.x : o.target.y, this.align = "x" === s ? o.target.y : o.target.x, t.toggleClass(this.clsPos + "-" + this.dir + "-" + this.align, !1 === this.offset)
                },
                getAxis: function () {
            ...
            t.component("accordion", {
                ...
                update: function () {
                    ...
                    if (this.items.length && this._changed) {
                        this.items.each(function (e, i) {
                            i = St(i), t.toggleNow(i.find(t.content), i.hasClass(t.clsOpen))
                        });
                        var e = !1 !== this.active && j(this.items.eq(Number(this.active))) || !this.collapsible && j(this.items.eq(0));
                ...
                methods: {
                    toggle: function (t, e) {
                        ...
                        (t = this.items.eq(n)).add(!this.multiple && s).each(function (n, o) {
                            var r = (o = St(o)).is(t),
                            ...
                            if (a || !r || i.collapsible || !(s.length < 2)) {
                                ...
                                o[0]._wrapper || (o[0]._wrapper = l.wrap("<div>").parent().attr("hidden", a)), i._toggleImmediate(l, !0), i.toggleElement(o[0]._wrapper, a, e).then(function () {
                                    o.hasClass(i.clsOpen) === a && (a || i._toggleImmediate(l, !1), o[0]._wrapper = null, l.unwrap())
                                })
                            }
                        })
                    }
        ...
        Me = function (t) {
            function e() {
                n || (n = !0, It.on("click", function (t) {
                    var e;
                    if (!t.isDefaultPrevented())
                        for (; i && i !== e && !u(t.target, i.$el) && (!i.toggle || !u(t.target, i.toggle.$el));) e = i, i.hide(!1)
                }))
            }
            var i;
            t.component("drop", {
                ...
                init: function () {
                    this.tracker = new et, this.clsDrop = this.clsDrop || "uk-" + this.$options.name, this.clsPos = this.clsDrop, this.$addClass(this.clsDrop)
                },
                ready: function () {
                    this.updateAria(this.$el), this.toggle && (this.toggle = t.toggle(y(this.toggle, this.$el), {
                        target: this.$el,
                        mode: this.mode
                    }))
                },
                events: [{
                    ...
                    handler: function (t) {
                        if (!t.isDefaultPrevented()) {
                            var e = t.target.hash;
                            e || t.preventDefault(), e && u(e, this.$el) || this.hide(!1)
                        }
                    }
                }, {
                    name: "beforescroll",
                    ...
                    handler: function (t) {
                        vt(t) || (i && i !== this && i.toggle && ~i.toggle.mode.indexOf("hover") && !u(t.target, i.$el) && !u(t.target, i.toggle.$el) && i.hide(!1), t.preventDefault(), this.show(this.toggle))
                    }
                }, {
                    name: "toggleshow",
                    handler: function (t, e) {
                    ...
                    name: "togglehide " + re,
                    handler: function (t, e) {
                        vt(t) || e && !this.$el.is(e.target) || (t.preventDefault(), this.toggle && ~this.toggle.mode.indexOf("hover") && this.hide())
                    }
                }, {
                    name: "beforeshow",
                    self: !0,
                    ...
                    handler: function (t) {
                        var e = t.target;
                        this.$el.is(e) ? (i = this.isActive() ? null : i, this.toggle.$el.removeClass(this.cls).attr("aria-expanded", "false").blur().find("a, button").blur(), this.tracker.cancel()) : i = null === i && u(e, this.$el) && this.isToggled() ? this : i
                    }
                }],
                update: {
                    write: function () {
                        this.isToggled() && !Lt.inProgress(this.$el) && this.position()
                    },
                    events: ["resize"]
                },
                methods: {
        ...
        je = function (t) {
            t.component("form-custom", {
                ...
                computed: {
                    ...
                    target: function () {
                        return this.$props.target && y(!0 === this.$props.target ? "> :input:first + :first" : this.$props.target, this.$el)
                    }
                },
                connected: function () {
                ...
                methods: {
                    match: function (t) {
                        ...
                        return t = t.each(function (t, n) {
                            var s, o, r;
                            0 === n.offsetHeight && (o = (s = St(n)).attr("style") || null, r = s.attr("hidden") || null, s.attr({
                ...
                update: {
                    write: function () {
                        ...
                        if (this.expand) {
                            ...
                            var o = ht(this.$el);
                            if (o < i / 2 && this.offsetTop && (n += o), !0 === this.offsetBottom) n += this.$el.next().outerHeight() || 0;
            ...
            i(function () {
                if (ee) {
                    ...
                    Nt.on("tap", function (t) {
                        var i = t.target;
                        return St("." + e).filter(function (t, e) {
                            return !u(i, e)
                        }).removeClass(e)
        ...
        Re = function (e) {
            ...
            e.component("icon", e.components.svg.extend({
                ...
                init: function () {
                    this.$addClass("uk-icon"), Bt && (this.icon = V(V(this.icon, "left", "right"), "previous", "next"))
                },
                disconnected: function () {
                    delete this.delay
                },
                ...
                methods: {
                    getSvg: function () {
                        var t = this,
                            e = this.getIcon();
                        return e ? C.resolve(e) : "complete" !== document.readyState ? C(function (e) {
                            t.delay = e
                        }) : C.reject("Icon not found.")
                    },
                    getIcon: function () {
                        return s[this.icon] ? (n[this.icon] || (n[this.icon] = this.parse(s[this.icon])), n[this.icon]) : null
                    }
                }
                ...
                connected: function () {
                    ...
                    this.svg.then(function (e) {
                        return 1 !== t.ratio && St(e).find("circle").css("stroke-width", 1 / t.ratio)
                    }, X)
                }
            }), e.icon.add = function (i) {
                Qt(s, i), Object.keys(i).forEach(function (t) {
                    return delete n[t]
        ...
        Ve = function (t) {
            t.component("modal", {
                ...
                return i = Qt({
                    ...
                    return t.modal.dialog(' <div class="uk-modal-body">' + (N(e) ? e : St(e).html()) + '</div> <div class="uk-modal-footer uk-text-right"> <button class="uk-button uk-button-primary uk-modal-close" autofocus>' + i.labels.ok + "</button> </div> ", i).$el.on("hide", n)
                })
        ...
        Xe = function (t) {
            t.component("navbar", {
                ...
                computed: {
                    boundary: function () {
                        return !0 === this.$props.boundary || this.boundaryAlign ? this.$el : this.$props.boundary
                    },
                    pos: function () {
                ...
                ready: function () {
                    this.dropbar && t.navbarDropbar(y(this.dropbar, this.$el) || St("<div></div>").insertAfter(this.dropbarAnchor || this.$el), {
                ...
                update: function () {
                    t.drop(St(this.dropdown + " ." + this.clsDrop, this.$el).filter(function (e, i) {
                ...
                events: [{
                    ...
                    handler: function (t) {
                        var e = t.currentTarget,
                            i = this.getActive();
                        i && i.toggle && !u(i.toggle.$el, e) && !i.tracker.movesTo(i.$el) && i.hide(!1)
                    }
                }],
                methods: {
                    getActive: function () {
                        var e = t.drop.getActive();
                        return e && !~e.mode.indexOf("click") && u(e.toggle.$el, this.$el) && e
                    }
                }
                ...
                events: [{
                    ...
                    handler: function (t, e) {
                        var i = e.$el;
                        if ("bottom" === e.dir && !u(i, this.$el)) return i.appendTo(this.$el), e.show(), !1
                    }
                }, {
                    name: "mouseleave",
                    handler: function () {
                ...
                methods: {
                    transitionTo: function (t) {
                        return this.$el.height(this.$el[0].offsetHeight ? this.$el.height() : 0), Mt.cancel(this.$el), Mt.start(this.$el, {
                            height: t
                        }, this.duration).then(null, X)
                    }
                }
            })
        },
        Qe = function (t) {
            t.component("offcanvas", {
                ...
                update: {
                    write: function () {
                        this.isToggled() && ((this.overlay || this.clsContentAnimation) && this.content.width(window.innerWidth - this.scrollbarWidth), this.overlay && (this.content.height(window.innerHeight), Ee && this.content.scrollTop(Ee.y)))
                    },
                    events: ["resize"]
                },
                events: [{
                    ...
                    handler: function (t) {
                        var e = t.currentTarget;
                        e.hash && this.content.find(e.hash).length && (Ee = null, this.hide())
                    }
                }, {
                    name: "beforescroll",
                    filter: function () {
                    ...
                    self: !0,
                    handler: function () {
                        this.content.removeClass(this.clsContentAnimation), ("none" === this.mode || this.getActive() && this.getActive() !== this) && this.panel.trigger(ae)
                    }
                }, {
                    name: "hidden",
                    self: !0,
                    handler: function () {
                        ...
                        this.panel.removeClass(this.clsSidebarAnimation + " " + this.clsMode), this.$el.removeClass(this.clsOverlay).css("display", ""), this.body.removeClass(this.clsContainer + " " + this.clsFlip + " " + this.clsOverlay).scrollTop(Ee.y), Nt.css("overflow-y", ""), this.content.width("").height(""), window.scrollTo(Ee.x, Ee.y), Ee = null
                    }
                }, {
                    name: "swipeLeft swipeRight",
                    handler: function (t) {
                        this.isToggled() && vt(t) && ("swipeLeft" === t.type && !this.flip || "swipeRight" === t.type && this.flip) && this.hide()
                    }
                }]
            })
        },
        Je = function (t) {
            t.component("responsive", {
                ...
                update: {
                    ...
                    write: function () {
                        this.dim && this.$el.height(qt.contain({
                            height: this.height,
                            width: this.width
                        }, this.dim).height)
                    },
            ...
            t.component("scroll", {
                ...
                methods: {
                    scrollTo: function (t) {
                        ...
                        i + s > n && (i = n - s), !1 !== a(this.$el, "beforescroll", [this, t]).result && St("html,body").stop().animate({
                ...
                events: {
                    click: function (t) {
                        t.isDefaultPrevented() || (t.preventDefault(), this.scrollTo(St(this.$el[0].hash).length ? this.$el[0].hash : "body"))
                    }
                }
            }), St.easing.easeOutExpo = St.easing.easeOutExpo || function (t, e, i, n, s) {
                        ...
                        this.elements.each(function (i, n) {
                            ...
                            if (o.show) {
                                if (!o.inview && !o.timer) {
                                    ...
                                    t.delay && e ? o.timer = setTimeout(a, t.delay * e) : a(), e++
                                }
        ...
        Ke = function (t) {
            t.component("scrollspy-nav", {
                ...
                computed: {
                    ...
                    targets: function () {
                        return St(this.links.toArray().map(function (t) {
                            return t.hash
                        }).join(","))
                    }
                },
                    ...
                    read: function () {
                        ...
                        this.active = !1, this.targets.each(function (n, s) {
                            ...
                            if (r || !(ht(t.targets.eq(n + 1)) <= e)) {
                                ...
                                return !(t.active = j(t.links.filter('[href="#' + s.id + '"]')))
                            }
                        })
                    },
                    write: function () {
        ...
        ti = function (e) {
            e.component("sticky", {
                ...
                computed: {
                    selTarget: function () {
                        return this.$props.selTarget && j(this.$props.selTarget, this.$el) || this.$el
                    }
                },
                connected: function () {
                    this.placeholder = St('<div class="uk-sticky-placeholder"></div>'), this.widthElement = this.$props.widthElement || this.placeholder, this.isActive || this.hide()
                },
                disconnected: function () {
                ...
                update: [{
                    write: function () {
                        ...
                        this.placeholder.css("height", "absolute" !== this.$el.css("position") ? n : "").css(this.$el.css(["marginTop", "marginBottom", "marginLeft", "marginRight"])), document.documentElement.contains(this.placeholder[0]) || this.placeholder.insertAfter(this.$el).attr("hidden", !0), this.width = this.widthElement.attr("hidden", null)[0].offsetWidth, this.widthElement.attr("hidden", !this.isActive), this.topOffset = ht(this.isActive ? this.placeholder : this.$el), this.bottomOffset = this.topOffset + n, ["top", "bottom"].forEach(function (n) {
                            i[n] = i.$props[n], i[n] && (t.isNumeric(i[n]) ? i[n] = i[n + "Offset"] + parseFloat(i[n]) : N(i[n]) && i[n].match(/^-?\d+vh$/) ? i[n] = window.innerHeight * parseFloat(i[n]) / 100 : (e = !0 === i[n] ? i.$el.parent() : y(i[n], i.$el)) && (i[n] = ht(e) + e[0].offsetHeight))
                    ...
                    read: function () {
                        this.offsetTop = ht(this.$el), this.scroll = window.pageYOffset, this.visible = this.$el.is(":visible")
                    },
                    write: function (t) {
                        var e = this;
                        void 0 === t && (t = {});
                        ...
                        if (!(n < 0 || !this.visible || this.disabled || this.showOnUp && !i))
                            if (this.inactive || n < this.top || this.showOnUp && (n <= this.top || "down" === i || "up" === i && !this.isActive && n <= this.bottomOffset)) {
                                ...
                                this.isActive = !1, this.animation && n > this.topOffset ? Lt.cancel(this.$el).then(function () {
                                    return Lt.out(e.$el, e.animation).then(function () {
                                        return e.hide()
                                    }, X)
                                }) : this.hide()
                            } else this.isActive ? this.update() : this.animation ? Lt.cancel(this.$el).then(function () {
                                e.show(), Lt.in(e.$el, e.animation).then(null, X)
                            }) : this.show()
                    },
                    events: ["scroll"]
                }],
                methods: {
                    ...
                    update: function () {
                        ...
                        this.bottom && this.scroll > this.bottom - this.offset && (e = this.bottom - this.scroll), this.$el.css({
                            ...
                            top: e + "px",
                            width: this.width
                        }), this.$hasClass(this.selTarget, this.clsActive) ? i || this.$el.trigger("inactive") : i && this.$el.trigger("active"), this.$toggleClass(this.clsBelow, this.scroll > this.bottomOffset), this.showOnUp ? Gt(function () {
        ...
        ni = function (e) {
            e.component("svg", {
                            ...
                            if (e) {
                                if (t.icon)
                                    if (s = e.getElementById(t.icon)) {
                                        ...
                                        r = r.replace(/<symbol/g, "<svg" + (~r.indexOf("xmlns") ? "" : ' xmlns="http://www.w3.org/2000/svg"')).replace(/symbol>/g, "svg>"), o = ii.parseFromString(r, "image/svg+xml").documentElement
                ...
                methods: {
                    getSvg: function () {
                        var e = this;
                        return this.src ? ei[this.src] ? ei[this.src] : (ei[this.src] = C(function (i, n) {
                        ...
                        }), ei[this.src]) : C.reject()
                    },
                    parse: function (t) {
                        var e = ii.parseFromString(t, "image/svg+xml");
        ...
        si = function (t) {
            t.component("switcher", {
                ...
                computed: {
                    connects: function () {
                        return y(this.connect, this.$el) || St(this.$el.next("." + this.clsContainer))
                    },
                    toggles: function () {
                ...
                events: [{
                    ...
                    handler: function (t) {
                        t.preventDefault(), this.show(St(t.currentTarget)[t.currentTarget.hasAttribute(this.attrItem) ? "attr" : "data"](this.attrItem))
                    }
                }, {
                    ...
                    handler: function (t) {
                        vt(t) && (t.preventDefault(), window.getSelection().toString() || this.show("swipeLeft" === t.type ? "next" : "previous"))
                    }
                }],
                update: function () {
                    this.updateAria(this.connects.children()), this.show(j(this.toggles.filter("." + this.cls + ":first")) || j(this.toggles.eq(this.active)) || this.toggles.first())
                },
                methods: {
                    show: function (t) {
                        for (var e, i = this, n = this.toggles.length, s = this.connects.children("." + this.cls).index(), o = s >= 0, r = w(t, this.toggles, s), a = "previous" === t ? -1 : 1, l = 0; l < n; l++, r = (r + a + n) % n)
        ...
        ri = function (t) {
            t.component("toggle", {
                ...
                events: [{
                    ...
                    handler: function (t) {
                        vt(t) || this.toggle("toggle" + (t.type === oe ? "show" : "hide"))
                    }
                }, {
                    name: "click",
                    filter: function () {
                        return ~this.mode.indexOf("click") || ee
                    },
                    handler: function (t) {
                        if (vt(t) || ~this.mode.indexOf("click")) {
                            var e = St(t.target).closest("a[href]")[0];
                            (St(t.target).closest('a[href="#"], button').length || e && (this.cls || !this.target.is(":visible") || e.hash && this.target.is(e.hash))) && t.preventDefault(), this.toggle()
                        }
                    }
                }],
                update: {
        ...
        li = function (t) {
            t.component("video", {
                ...
                ready: function () {
                    this.player = new pe(this.el), this.automute && this.player.mute()
                },
                update: {
                    write: function () {
    ...
    return _e.version = "3.0.0-beta.30",
        function (t) {
            t.mixin.class = Se, t.mixin.modal = De, t.mixin.position = Ie, t.mixin.togglable = Oe
        }(_e),
        function (t) {
            var e = 0,
                i = 0;
            n(window, "load resize", t.update), n(window, "scroll", function (i) {
                i.dir = e < window.pageYOffset ? "down" : "up", e = window.pageYOffset, t.update(i), ce.flush()
            }), le && n(document, le, function (t) {
                var e = t.target;
            ...
            }, !0), t.use(ri), t.use(Ne), t.use(Be), t.use(li), t.use(Pe), t.use(Me), t.use(He), t.use(je), t.use(Le), t.use(We), t.use(qe), t.use(Ye), t.use(Fe), t.use(ze), t.use(ai), t.use(Ve), t.use(Ue), t.use(Xe), t.use(Qe), t.use(Je), t.use(Ge), t.use(Ze), t.use(Ke), t.use(ti), t.use(ni), t.use(Re), t.use(si), t.use(oi)
        }(_e), _e.use(yt), _e.use(xt), _e.use(kt), _e.use(Ct), _e.use(Tt), _e.use(_t), _e.use(At), _e.use(Et),
        function (t) {
            function e() {
                s(document.body, r), ce.flush(), new Jt(function (e) {
            ...
            var o = document.documentElement,
                r = t.connect,
                a = t.disconnect;
            Jt ? document.body ? e() : new Jt(function () {
